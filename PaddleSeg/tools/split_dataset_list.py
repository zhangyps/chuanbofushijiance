...
def parse_args():
    ...
    parser.add_argument('dataset_root', help='the dataset root path', type=str, default='./home/dl/zy/PaddleSeg/custom_dataset/')
    parser.add_argument(
        'images_dir_name', help='the directory name of images', type=str, default='JPEGImages')
    parser.add_argument(
        'labels_dir_name', help='the directory name of labels', type=str, default='Annotations')
    parser.add_argument(
        '--split', help='', nargs=3, type=float, default=[0.8, 0.1, 0.1])
    parser.add_argument(
        '--separator',
        dest='separator',
