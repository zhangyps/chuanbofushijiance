...
def parse_args():
    ...
    parser.add_argument(
        "--config", dest="cfg", help="The config file.", default='./configs/segformer/segformer_b1_cityscapes_1024x1024_160k.yml', type=str)
    parser.add_argument(
        '--model_path',
        dest='model_path',
    ...
    parser.add_argument(
        ...
        type=str,
        default='./custom_dataset/test.txt')
    parser.add_argument(
        '--save_dir',
        dest='save_dir',
